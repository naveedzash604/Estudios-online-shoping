<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin manage customer.aspx.cs" Inherits="Admin_manage_customer" %>
...
<body style="height: 265px; margin-right: 1px; width: 1520px;">
    ...
    <table class="auto-style2">
        ...
        <div class="auto-style172" style="background-color: #666666;">
            <div class="auto-style173">
                <h2 style="color: #FFFFFF; font-size: 27px; font-weight: 700; text-decoration: underline;" class="auto-style174"> Manage customers </h2>
            </div>
        </div>
 
 <div class="auto-style155">
            <asp:TextBox ID="TextBox1" runat="server" placeholder=" Search by name" CssClass="auto-style177"></asp:TextBox>
       ...
       <asp:GridView class="table" ID="gvproduct" runat="server"   CaptionAlign="Top"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:Label ID="lblpid" Visible="false" runat="server" Text='<%# Eval("id") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Full_name">
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Mobile_number" runat="server" Text='<%# Eval("Mobile_number") %>'></asp:Label>
                        </ItemTemplate>
 ...
 <!-- Footer end-->
    ...
    <!-- End copyright  -->
     ...
     <div class="auto-style179">
            <asp:Button ID="Button1" runat="server" Text="Search" OnClick="Button1_Click" Width="100px" />
                </div>
